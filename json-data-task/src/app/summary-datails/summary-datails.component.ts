...
export class SummaryDatailsComponent implements OnInit {
  ...
  constructor(private summaryService: SummaryService, private fb: FormBuilder, private router: Router) {
    this.formInIt();
  }
  ...
  public updateSummary() {
    ...
    this.summaryService.updateSummary(this.selectedSummaryData.id, formValue).subscribe((res) => {
